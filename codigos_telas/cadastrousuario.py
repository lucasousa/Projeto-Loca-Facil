...
class Ui_cadastrousuario(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit_5.setGeometry(QtCore.QRect(235, 170, 571, 31))
        self.lineEdit_5.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.lineEdit_5.setObjectName("lineEdit_5")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(395, 100, 201, 61))
        font = QtGui.QFont()
        ...
        self.label_6.setGeometry(QtCore.QRect(175, 230, 41, 40))
        font = QtGui.QFont()
        font.setFamily("Gadugi")
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.label_7.setGeometry(QtCore.QRect(495, 220, 71, 40))
        font = QtGui.QFont()
        font.setFamily("Gadugi")
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.lineEdit_7.setGeometry(QtCore.QRect(235, 230, 241, 31))
        self.lineEdit_7.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.lineEdit_7.setObjectName("lineEdit_7")
        self.lineEdit_8 = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_8.setGeometry(QtCore.QRect(575, 230, 231, 31))
        self.lineEdit_8.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.lineEdit_8.setObjectName("lineEdit_8")
        self.label_8 = QtWidgets.QLabel(self.centralwidget)
        self.label_8.setGeometry(QtCore.QRect(175, 290, 41, 40))
        font = QtGui.QFont()
        font.setFamily("Gadugi")
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.lineEdit_9.setGeometry(QtCore.QRect(235, 290, 241, 31))
        self.lineEdit_9.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.lineEdit_9.setObjectName("lineEdit_9")
        self.label_9 = QtWidgets.QLabel(self.centralwidget)
        self.label_9.setGeometry(QtCore.QRect(505, 290, 41, 40))
        font = QtGui.QFont()
        font.setFamily("Gadugi")
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.radioButton.setGeometry(QtCore.QRect(575, 300, 95, 20))
        self.radioButton.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.radioButton.setObjectName("radioButton")
        self.radioButton_2 = QtWidgets.QRadioButton(self.centralwidget)
        self.radioButton_2.setGeometry(QtCore.QRect(705, 300, 95, 20))
        self.radioButton_2.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.radioButton_2.setObjectName("radioButton_2")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(173, 620, 131, 41))
        font = QtGui.QFont()
        font.setFamily("Gadugi")
...
"color: #FFFFFF;")
        ...
        self.label_10.setGeometry(QtCore.QRect(175, 420, 59, 40))
        font = QtGui.QFont()
        font.setFamily("Gadugi")
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.lineEdit_10.setGeometry(QtCore.QRect(285, 490, 381, 31))
        ...
        self.lineEdit_11.setGeometry(QtCore.QRect(285, 430, 381, 31))
        self.lineEdit_11.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.lineEdit_11.setObjectName("lineEdit_11")
        self.label_11 = QtWidgets.QLabel(self.centralwidget)
        self.label_11.setGeometry(QtCore.QRect(175, 480, 59, 40))
        font = QtGui.QFont()
        font.setFamily("Gadugi")
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.lineEdit_12.setGeometry(QtCore.QRect(285, 550, 381, 31))
        ...
        self.label_12.setGeometry(QtCore.QRect(175, 543, 101, 40))
        font = QtGui.QFont()
        font.setFamily("Gadugi")
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.label_13.setGeometry(QtCore.QRect(255, 370, 531, 40))
        font = QtGui.QFont()
        font.setFamily("Gadugi")
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(680, 620, 131, 41))
        font = QtGui.QFont()
        font.setFamily("Gadugi")
        font.setPointSize(10)
        font.setBold(True)
